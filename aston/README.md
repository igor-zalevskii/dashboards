# Итоговая работа - АНАЛИЗ И ВИЗУАЛИЗАЦИЯ ПРОДАЖ ИНТЕРНЕТ-МАГАЗИНА  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/03d.png)  
...
## **Файлы решения**:  
- [`solution.xlsx`](module_01_excel_data_viz/topic_10_final/solution.xlsx)  
- [`solution.pbix`](module_01_excel_data_viz/topic_10_final/solution.pbix)  
...
[Ссылка на условие](https://wiki.astondevs.ru/spaces/LDA/pages/104954497/%D0%98%D1%82%D0%BE%D0%B3%D0%BE%D0%B2%D0%B0%D1%8F+%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0+-+%D0%90%D0%BD%D0%B0%D0%BB%D0%B8%D0%B7+%D0%B8+%D0%92%D0%B8%D0%B7%D1%83%D0%B0%D0%BB%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F+%D0%9F%D1%80%D0%BE%D0%B4%D0%B0%D0%B6+%D0%98%D0%BD%D1%82%D0%B5%D1%80%D0%BD%D0%B5%D1%82-%D0%9C%D0%B0%D0%B3%D0%B0%D0%B7%D0%B8%D0%BD%D0%B0)  


## Решение  
### Этап 1. Подготовка среды

Создание палитры цветов, используемых компанией:  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00a.png)  

Создание кастомной палитры в Excel:  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00b.png)  

Примеры использования кастомной палитры:  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00d.png)  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00e.png)  

[Проверка палитры цветов](https://color.adobe.com/ru/create/color-accessibility) на восприятие людьми с дальтонизмом:  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00f.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00_erd.png)  

#### Импорт данных  

Загрузим все csv-файлы (6 таблиц) в Power Query.  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/01a.png)  

Используя Power Query, проведем очистку данных:  

- Удаление неиспользуемых данных (столбцы, таблицы).  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/01b.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/01c.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00python.png)  


![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/00_excel.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/01d.png)  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/01e.png)  

Создадим вычисляемый столбец общей суммы продажи клиентов.  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/01f.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/02a.png)  
##### Анализ динамики во времени
Проведем анализ динамики во времени

В 2023 и 2024 годах в зимняя время продажи снижались.  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/02b.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/02f.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/02g.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/02h.png)  

Видим, что:  
- Средний чек: 2201.  
- Среднее количество товаров в заказе: 2 шт.  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/02i.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/03a.png)  
...
![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/03b.png)  

![Скриншот](module_01_excel_data_viz/topic_10_final/screenshots/03c.png)  
